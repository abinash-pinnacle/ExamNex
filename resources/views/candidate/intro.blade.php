        ...
        <div class="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
            ...
            <div class="flex items-center gap-2 text-right">
                ...
                <div class="text-sm leading-tight">
                    <div class="font-semibold text-slate-700" id="clock-date">{{ $now->ist()->format('l, j F Y') }}</div>
                    <div class="text-slate-400 text-xs" id="clock-time">{{ $now->ist()->format('h:i A') }}</div>
                </div>
            </div>
        </div>
    </header>
