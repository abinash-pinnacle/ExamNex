...
@php
    ...
    $qCount = $test->test_questions_count ?? $test->testQuestions()->count();
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
                        @php
                            $meta = [
                                ...
                                ['bg-blue-50 text-brand', 'M12 7v5l3 2M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18z', $test->duration_minutes.' Min', 'Duration'],
            ...
            <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4">
                @php
                    $ins = [
                        ...
                        ['bg-amber-50 text-amber-500', 'M12 7v5l3 2M12 3a9 9 0 1 0 0 18 9 9 0 0 0 0-18z', 'Complete in time', 'You have '.$test->duration_minutes.' minutes.'],
